...
RSpec.describe Maglev::Generators::InstallGenerator do
  it "creates an initializer and pgvector migration" do
    Dir.mktmpdir("maglev-generator") do |destination|
      ...
      expect(File.read(migrations.first)).to include("t.string :resource_identifier, null: false")
      expect(File.read(migrations.first)).to include("t.string :representation_version, null: false")
      expect(File.read(migrations.first)).to include("t.string :knowledge_policy_digest, limit: 64, null: false")
